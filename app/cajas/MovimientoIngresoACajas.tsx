//@/app/cajas/MoviminetoIngresoACajas.tsx
"use client";
...
import { createCobro } from "../_actions/crud/crudCobro";
import { Cobro } from "@prisma/client";
import { DataCobro } from "../types";

const MovimientoIngresoACajas = ({ cajas }) => {
      ...
      <div className="inset-0 flex items-center justify-center">
        ...
        >
          <div className="flex flex-row items-center justify-center min-w-32">
            <HiArrowDown color="green" size="16" />
            <p className="hidden mx-1 md:block w-14">Ingresar</p>
          </div>
        </button>
      </div>
...
export default MovimientoIngresoACajas;
